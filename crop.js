...
function openCropTool(sourceCanvas) {
  return new Promise((resolve) => {
    ...
    title.style.cssText = "color:#fff;font-family:ui-rounded,-apple-system,BlinkMacSystemFont,sans-serif;font-weight:700;font-size:16px;margin-bottom:14px;";
    overlay.appendChild(title);

    const hint = document.createElement('div');
    hint.textContent = 'Ecken ziehen, damit nur der Beleg im Rahmen liegt';
    hint.style.cssText = "color:#9DBEBC;font-family:-apple-system,BlinkMacSystemFont,sans-serif;font-size:12px;margin-bottom:14px;text-align:center;";
    ...
    btnFull.style.cssText = "flex:1;padding:13px;border-radius:14px;border:2px solid #fff;background:transparent;color:#fff;font-family:ui-rounded,-apple-system,BlinkMacSystemFont,sans-serif;font-weight:700;font-size:14px;";
    const btnConfirm = document.createElement('button');
    btnConfirm.textContent = 'Zuschnitt übernehmen';
    btnConfirm.style.cssText = "flex:1;padding:13px;border-radius:14px;border:none;background:linear-gradient(135deg,#12766C,#0B4F49);color:#fff;font-family:ui-rounded,-apple-system,BlinkMacSystemFont,sans-serif;font-weight:700;font-size:14px;";
